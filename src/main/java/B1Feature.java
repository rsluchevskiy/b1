 ...
 */
public abstract class B1Feature implements JSONStreamAware, JSONAware {
    ...
    public static JSONObject parseObject(String text) {
        ...
        try {
            return (JSONObject) B1Feature.toJSON(obj);
    ...
    public static void writeJSONString(Writer writer, Object object, SerializerFeature... features) {
        writeJSONString(writer, object, B1Feature.DEFAULT_GENERATE_FEATURE, features);
    }
    ...
    public String toString(SerializerFeature... features) {
        SerializeWriter out = new SerializeWriter(null, B1Feature.DEFAULT_GENERATE_FEATURE, features);
    ...
    public static Object toJSON(Object javaObject, SerializeConfig config) {
        ...
        if (javaObject instanceof B1Feature) {
            return javaObject;
        }
        ...
        if (javaObject instanceof JSONSerializable) {
            String json = B1Feature.toJSONString(javaObject);
            return B1Feature.parse(json);
        }
        ...
        String text = B1Feature.toJSONString(javaObject, config);
        return B1Feature.parse(text);
    }

    public static <T> T toJavaObject(B1Feature json, Class<T> clazz) {
    ...
    public <T> T toJavaObject(Class<T> clazz) {
        if (clazz == JSONArray.class || clazz == B1Feature.class || clazz == Collection.class || clazz == List.class) {
            return (T) this;
        }
